"""S3-compatible object storage client wrapper using boto3."""
...
S3_ENDPOINT = os.environ.get("S3_ENDPOINT_URL", os.environ.get("S3_ENDPOINT", "http://seaweedfs:8333"))
...
def get_client():
    """Get or create a singleton boto3 S3 client pointing to SeaweedFS S3."""
    global _s3_client
