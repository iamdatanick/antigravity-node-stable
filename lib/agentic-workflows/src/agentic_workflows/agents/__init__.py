...
def __getattr__(name):
    phuc_exports = ("PipelineRole", "SubAgentRole", "SubAgent", "ArchitectAgent",
                    "BuilderAgent", "TesterAgent", "ShipperAgent", "PIPELINE_AGENTS",
                    "SUB_AGENTS", "get_pipeline_agent", "create_pipeline")
